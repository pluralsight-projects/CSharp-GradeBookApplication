...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (type.ToLower().Equals("standard")) gradeBook = new StandardGradeBook(name, isWeighted);

            else if (type.ToLower().Equals("ranked")) gradeBook = new RankedGradeBook(name, isWeighted);
